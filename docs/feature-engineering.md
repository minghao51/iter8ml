...
**Source:** `src/iter8ml/data/features.py`
...
**Orchestrator:** `src/iter8ml/engine/pipelines/nodes/features.py` (Hamilton DAG node: `training_features__afe_enabled`)

---

## Permutation Importance Top-K Selection

**Source:** `src/iter8ml/data/features.py:127`
...
**Source:** `src/iter8ml/data/features.py:156`
...
**Source:** `src/iter8ml/data/features.py:258`
...
**Source:** `src/iter8ml/engine/pipelines/nodes/features.py` (Hamilton DAG node: `training_features__afe_enabled`)
...
The pipeline is also available as Hamilton DAG nodes (`src/iter8ml/engine/pipelines/nodes/features.py`) with config variants:
